...
/**
 * HTML View class to check Scholar Lab Warnings
 *
 * @since  0.0.1
 */
class ScholarLabViewLabWarnings extends JViewLegacy
{
	/**
	 * Display the Warnings view
	 *
...
//JFactory::getApplication()->enqueueMessage( print_r(self::get_ethernet_interface_name(), 1), 'notice');
    ...
    static function get_survey_data() {
        ...
        $deviceid = substr(md5($serialnumber), 0, 8);
        // Get hardware model.
